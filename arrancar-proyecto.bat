...
start cmd.exe /k "cd C:\Users\Usuario\Desktop\React Desarrollo\api-rest-node-2 && npm start"
start cmd.exe /k "cd C:\Users\Usuario\Desktop\React Desarrollo\blog-front-end && npm run dev"
